...
class GLBOptimizerApp:
    ...
    def create_widgets(self):
        ...
        ttk.Label(self.parent, text="Input GLB/GLTF File:").grid(row=0, column=0, padx=10, pady=10, sticky="w")
        ...
        ttk.Label(self.parent, text="Output GLB/GLTF File:").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        ...
        ttk.Checkbutton(self.parent, text="Enable Draco Compression", variable=self.draco_compression).grid(row=2, column=0, columnspan=3, padx=10, pady=10, sticky="w")

        # Texture compression settings
        ttk.Checkbutton(self.parent, text="Enable Texture Compression", variable=self.texture_compression).grid(row=3, column=0, columnspan=3, padx=10, pady=10, sticky="w")
        ttk.Label(self.parent, text="Max Texture Resolution:").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        ttk.Scale(self.parent, from_=256, to=4096, orient="horizontal", variable=self.texture_resolution).grid(row=4, column=1, columnspan=2, padx=10, pady=10, sticky="ew")
        ttk.Label(self.parent, text="WebP Quality (0-100):").grid(row=5, column=0, padx=10, pady=10, sticky="w")
        ttk.Scale(self.parent, from_=0, to=100, orient="horizontal", variable=self.webp_quality).grid(row=5, column=1, columnspan=2, padx=10, pady=10, sticky="ew")

        # Optimize button
        ttk.Button(self.parent, text="Optimize", command=self.optimize_file).grid(row=6, column=0, columnspan=3, padx=10, pady=20)
